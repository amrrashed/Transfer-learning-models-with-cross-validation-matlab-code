...
%%cross validation
%load images
digitDatasetPath = fullfile('D:\CIT project\datasets\ultrasonic images\us-dataset\modified 299');
...
%     augtestimds = augmentedImageDatastore([299 299],imdsTest);
    ...
    save(sprintf('xception_%d_among_%d_folds',fold_idx,num_folds),'netTransfer','test_idx','train_idx','labeltest','labeltrain');
    delete(findall(0))
